...
var mutual_card_info={'deck':[],'discard':[]}
#needs rpc for syncing autoload info like card variables {card_path:{variablename:what it should be}}
...
func internal_update(deck:Array,discard:Array):
	...
	transfer_card_data(mutual_card_info)
